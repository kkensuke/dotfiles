...
The Zsh and alias configuration are also documented here:

- [Zsh](https://kkensuke.github.io/myjb-en/pages/basic/zsh.html)
- [Alias](https://kkensuke.github.io/myjb-en/pages/basic/alias.html)
